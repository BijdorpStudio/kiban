 ...
 *   rejection.
 */
public sealed class IbanParseException(
     ...
     */
    public class UnknownCountryCode
    internal constructor(
        input: String,
    ...
    public class WrongChecksum internal constructor(input: String) :
