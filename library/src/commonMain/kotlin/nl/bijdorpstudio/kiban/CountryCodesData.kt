 ...
 * Regenerate with: kotlin scripts/generate_country_data.main.kts --registry <registry.txt> --rev
 * <NN> Updated to SWIFT IBAN Registry version 102 on 2026-07-29.
 */
internal object CountryCodesData {
    ...
    /**
     * Lengths for each country's IBAN. The indices match the indices of [COUNTRY_CODES], the values
    ...
    /**
     * Contains the start- and end-index (as per [String.substring]) of the bank code and branch
     * code within a country's IBAN format. Mask:
     * ```
    ...
    public val BANK_CODE_BRANCH_CODE: IntArray =
        intArrayOf(
            /* AD */ 4 or
                ...
                (8 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((8 + 4) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* AE */ 4 or
                ((4 + 3) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* AL */ 4 or
                ((4 + 3) shl BANK_IDENTIFIER_END_SHIFT) or
                (7 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((7 + 5) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* AO */ 0 or
                ((0 + 0) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* AT */ 4 or
                ((4 + 5) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* AZ */ 4 or
                ((4 + 4) shl BANK_IDENTIFIER_END_SHIFT) or
            ...
            /* BA */ 4 or
                ((4 + 3) shl BANK_IDENTIFIER_END_SHIFT) or
                (7 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((7 + 3) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* BE */ 4 or
                ((4 + 3) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            ...
            /* BI */ 4 or
                ((4 + 5) shl BANK_IDENTIFIER_END_SHIFT) or
                (9 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((9 + 5) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* BJ */ 0 or
                ((0 + 0) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* BR */ 4 or
                ((4 + 8) shl BANK_IDENTIFIER_END_SHIFT) or
                (12 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((12 + 5) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* BY */ 4 or
                ((4 + 4) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            ...
            /* DZ */ 0 or
                ...
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* EE */ 4 or
                ((4 + 2) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* EG */ 4 or
                ((4 + 4) shl BANK_IDENTIFIER_END_SHIFT) or
            ...
            /* GB */ 4 or
                ((4 + 4) shl BANK_IDENTIFIER_END_SHIFT) or
                (8 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((8 + 6) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* GE */ 4 or
                ((4 + 2) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            ...
            /* GR */ 4 or
                ((4 + 3) shl BANK_IDENTIFIER_END_SHIFT) or
                (7 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((7 + 4) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* GT */ 4 or
                ((4 + 4) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            ...
            /* HN */ 4 or
                ...
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* HR */ 4 or
                ((4 + 7) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* HU */ 4 or
                ((4 + 3) shl BANK_IDENTIFIER_END_SHIFT) or
            ...
            /* IQ */ 4 or
                ((4 + 4) shl BANK_IDENTIFIER_END_SHIFT) or
                (8 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((8 + 3) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* IR */ 0 or
                ((0 + 0) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* IS */ 4 or
                ((4 + 2) shl BANK_IDENTIFIER_END_SHIFT) or
                (6 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((6 + 2) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* IT */ 5 or
                ((5 + 5) shl BANK_IDENTIFIER_END_SHIFT) or
                (10 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((10 + 5) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* JO */ 4 or
                ((4 + 4) shl BANK_IDENTIFIER_END_SHIFT) or
                (8 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((8 + 4) shl BRANCH_IDENTIFIER_END_SHIFT),
            ...
            /* MT */ 4 or
                ((4 + 4) shl BANK_IDENTIFIER_END_SHIFT) or
                (8 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((8 + 5) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* MU */ 4 or
                ((4 + 6) shl BANK_IDENTIFIER_END_SHIFT) or
                (10 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((10 + 2) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* MZ */ 0 or
                ((0 + 0) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            ...
            /* RS */ 4 or
                ...
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* RU */ 4 or
                ((4 + 9) shl BANK_IDENTIFIER_END_SHIFT) or
                (13 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((13 + 5) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* SA */ 4 or
                ((4 + 2) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
            ...
            /* TN */ 4 or
                ((4 + 2) shl BANK_IDENTIFIER_END_SHIFT) or
                (6 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((6 + 3) shl BRANCH_IDENTIFIER_END_SHIFT),
            /* TR */ 4 or
                ((4 + 5) shl BANK_IDENTIFIER_END_SHIFT) or
                (0 shl BRANCH_IDENTIFIER_BEGIN_SHIFT) or
                ((0 + 0) shl BRANCH_IDENTIFIER_END_SHIFT),
